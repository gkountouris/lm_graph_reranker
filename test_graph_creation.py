...
def generate_adj_data_from_grounded_concepts_umls__use_glove(grounded_path, cpnet_graph_path, output_path, num_processes):
    """
...
if __name__ == "__main__":
    ...
    # with open('./data/medqa/graph/dev.graph.adj.pk', "rb") as file:
    ...
    grounded = './data/medqa/grounded/dev.grounded.jsonl'
    graph = './data/medqa/graph/dev_test.graph.adj.pk'
    umls_graph = './data/umls/umls.graph'
    
    generate_adj_data_from_grounded_concepts_umls__use_glove(grounded, umls_graph, graph, 1)
