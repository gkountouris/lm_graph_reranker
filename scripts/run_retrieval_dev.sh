...
load_model_path=saved_models/drums_retriever__mixed_ih_false_load__elr1e-5_dlr1e-4_b32_ufz0_e80_sd5__20240601_173409/model.pt.74
args=$@
...
###### Training ######
python3 -u drums_retriever.py --mode eval \
    --dataset $dataset \
