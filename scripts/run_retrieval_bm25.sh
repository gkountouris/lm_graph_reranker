...
load_model_path=runs/pubmedqa/drums_retriever__pubmedqa_ih_false_load__elr2e-5_dlr1e-4_b4_ufz0_e20_sd5__20240320_065602/model.pt.7
args=$@
...
tf_idf_path=data/BioASQ/tensors
kg=umls
...
###### Training ######
python3 -u drums_retriever_bm25.py --mode train \
    --dataset $dataset \
