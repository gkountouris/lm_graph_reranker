...
def add_data_arguments(parser):
    ...
    parser.add_argument('--ent_emb_paths', default=['ent_emb_blbertL'], nargs='+', help='sources for entity embeddings')
    parser.add_argument('--tf_idf_path', default=['data/pubmed/sparse_matrix.npz'], nargs='+', help="The path to the retrieved KG subgraphs of the training set.")
    parser.add_argument('--kg_vocab_path', default="data/umls/concepts.txt", help='kg vocab file')
    # dataset specific
    parser.add_argument('-ds', '--dataset', default='medqa', help='dataset name')
...
def add_optimization_arguments(parser):
    parser.add_argument('--loss', default='cross_entropy', choices=['margin_rank', 'cross_entropy', 'custom_rank_loss'], help='model type')
